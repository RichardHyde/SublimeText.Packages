...
'''.splitlines()
	...
	def on_done(self, user_input):
		for region in self.view.sel():
			...
			self.view.insert(self.edit, region.begin(), self.banner(user_input))

	def run(self, edit):
		self.edit = edit
		self.view.window().show_input_panel("Enter Banner Text:", 'banner', self.on_done, None, None)
